...
namespace _Emulator
{
    class NewInventoryGUIWindow
    {
        ...
        private string[] otherKindKey = new string[7]
        {
            "CLOTH",
            "ACCESSORY",
            "CHARACTER",
        ...
        private void DoTitle()
        {
            ...
            LabelUtil.TextOut(pos, "Inventory manager", "BigLabel", GlobalVars.Instance.txtMainColor, new Color(0f, 0f, 0f, 0f), TextAnchor.UpperCenter);
        }
        ...
        private void DoOthers()
        {
            ...
            int num = 0;
            int[] catTypes = new int[7] { 2, 3, 4, 6, 7, 8, 0 };
    ...
    class NewInventoryGUI : MonoBehaviour
    {
        public static NewInventoryGUI instance;

        public bool hidden = true;

        private NewInventoryGUIWindow wnd;
